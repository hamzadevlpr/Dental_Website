    ...
    <div className="rounded-2xl border-[#14a085] border bg-white p-[6px]">
      <div className="relative flex h-[180px] w-full items-center justify-center rounded-xl p-4">
        ...
        <button
          ...
          className="cursor-pointer group absolute top-2 right-1 rounded-md px-2 py-1 text-sm text-[#14a085]"
        >
          <Heart
            size={24}
            className={`stroke-current fill-${
              isFavorite ? "current" : "transparent"
      ...
      <div className="p-2 pt-0">
        ...
        <div className="flex items-center">
          <span className="mr-2 text-lg font-medium text-[#14a085]">
            PKR {price}
          </span>
          {discountedPrice && (
        ...
        <div className="flex gap-[10px]">
          <button
            ...
            className="cursor-pointer rounded-md bg-[#d7fdf6] p-2 hover:bg-[#aef5e8] focus:outline-[#d7fdf6]"
            aria-label={`View details of ${title}`}
          >
            <BadgeInfo color="#14a085" />
          </button>
          <button
